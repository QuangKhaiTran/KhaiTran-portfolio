...
export const profile: Profile = {
  ...
  bio: "I help startups and SMBs turn messy operations into reliable software — internal tools, SaaS MVPs, and AI automation. I've shipped products across fintech, hospitality, retail, and legal tech, always with a focus on clear scope, weekly demos, and measurable outcomes.",
  longBio:
    "Based in Ho Chi Minh City, I work with clients in the US, EU, and Southeast Asia. I handle the full stack — React/Next.js frontends, Node.js/NestJS APIs, PostgreSQL databases, and cloud deployment on AWS or Vercel. When a project needs AI, I build practical integrations (chatbots, document extraction, workflow agents) that plug into existing tools — not science experiments.",
  skills: [
    "React & Next.js",
    "Node.js & NestJS",
    "PostgreSQL & MongoDB",
